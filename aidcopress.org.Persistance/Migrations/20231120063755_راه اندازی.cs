...
{
    public partial class راهاندازی : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Rahkaran_cod = table.Column<int>(type: "int", nullable: false),
                    Personel_code = table.Column<int>(type: "int", nullable: false),
                    First_name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Last_name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Semat = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Shoghl = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {

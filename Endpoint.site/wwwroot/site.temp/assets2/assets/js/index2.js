$(function() {
    ...
    new ApexCharts(document.querySelector("#chart5"), e).render(), Highcharts.chart("chart6", {
        ...
        title: {
            text: "وضعیت منابع ترافیک شهریور, 1400"
        },
        accessibility: {
            announceNewData: {
                enabled: !0
        ...
        subtitle: {
            text: "نسبت استفاده از دستگاه ها توسط کاربران"
        },
        tooltip: {
    ...
    e = {
        ...
        labels: ["کروم", "فایرفاکس", "ادج", "اپرا", "سافاری"],
        fill: {
            opacity: 1
        },
        stroke: {
    ...
    new ApexCharts(document.querySelector("#chart9"), e).render(), jQuery("#geographic-map").vectorMap({
        ...
        onRegionClick: function(e, t, o) {
            var r = 'شما کلیک کردید "' + o + '" که دارای کد: ' + t.toUpperCase();
            alert(r)
        }
    }),

$(function () {
    ...
    Highcharts.chart('chart1', {
        ...
        title: {
            text: 'سهم بازار مرورگر در شهریور 1402'
        },
        tooltip: {
    ...
    Highcharts.chart('chart2', {
        ...
        title: {
            text: 'سهم بازار مرورگر در مهر 1401'
        },
        tooltip: {
            pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
        },
    ...
    Highcharts.chart('chart3', {
        ...
        tooltip: {
            headerFormat: '',
            pointFormat: '<span style="color:{point.color}">\u25CF</span> <b> {point.name}</b><br/>' + 'حوزه (square km): <b>{point.y}</b><br/>' + 'تراکم جمعیت (مردم در هر کیلومتر مربع): <b>{point.z}</b><br/>'
        },
        series: [{
            minPointSize: 10,
            innerSize: '20%',
    ...
    Highcharts.chart('chart4', {
        ...
        title: {
            text: 'سهم بازار مرورگر در یک وب سایت خاص، 1402'
        },
        tooltip: {
            pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
        },
    ...
    var colors = Highcharts.getOptions().colors,
        categories = ['کروم', 'فایرفاکس', 'اینترنت اکسپلور', 'سافاری', 'ادج', 'اپرا', 'دیگر'],
        data = [{
            y: 62.74,
            color: colors[2],
            drilldown: {
            ...
            drilldown: {
                name: 'اینترنت اکسپلور',
                categories: ['اینترنت اکسپلور v11.0', 'اینترنت اکسپلور v10.0', 'اینترنت اکسپلور v9.0', 'اینترنت اکسپلور v8.0'],
                data: [
                    6.2,
                    0.29,
                    0.27,
    ...
    Highcharts.chart('chart5', {
        ...
        title: {
            text: 'سهم بازار مرورگر، شهریور 1399'
        },
        subtitle: {
    ...
    Highcharts.chart('chart7', {
        ...
        xAxis: {
            categories: ['آفریقا', 'آمریکا', 'آسیا', 'اروپا', 'استرالیا'],
            title: {
                text: null
            }
        },
    ...
    Highcharts.chart('chart9', {
        ...
        xAxis: {
            categories: ['سیب', 'نارنگی', 'آناناس', 'لیمو', 'موز']
        },
        yAxis: {
            min: 0,
            title: {
    ...
    Highcharts.chart('chart10', {
        ...
        title: {
            text: 'سهم بازار مرورگر شهریور 1398'
        },
        subtitle: {
    ...
    Highcharts.chart('chart11', {
        ...
        subtitle: {
            text: 'منبع: <a href="https://thebulletin.org/2006/july/global-nuclear-stockpiles-1945-2006">' + 'thebulletin.org</a> &amp; <a href="https://www.armscontrol.org/factsheets/Nuclearweaponswhohaswhat">' + 'armscontrol.org</a>'
        },
        xAxis: {
            allowDecimals: false,
            labels: {
            ...
            accessibility: {
                rangeDescription: 'محدوده: 1350 تا 1398.'
            }
        },
        yAxis: {
            title: {
    ...
    Highcharts.chart('chart14', {
        ...
        xAxis: {
            categories: ['سیب', 'پرتقال', 'گلابی', 'انگور', 'موز']
        },
        credits: {
            enabled: false
        },
